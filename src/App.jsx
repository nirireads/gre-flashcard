...
const App = () => {
  ...
  return (
    <div className="app-container flex flex-col item-center justify-center border border-black h-screen w-screen">
      ...
      <div className="flex justify-center">
        {offset + chunkSize < vocabulary.length && (
          <button className="load-more-btn w-fit" onClick={handleNextChunk}>
            Load More Words
          </button>
        )}
      </div>
